...
def load_fd_details():
    ...
    if not fd_id:
        messagebox.showerror("Input Error", "FD ID must be provided!")
        return
...
def save_fd_details():
    ...
    if not (fd_id and bank_name and deposit_amount and start_date and maturity_date and interest_rate):
